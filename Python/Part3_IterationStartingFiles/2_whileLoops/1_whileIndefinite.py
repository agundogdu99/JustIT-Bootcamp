...
# prints a string format of the current time
...
# Changes the default behaviour after a print statement
...
# used to overwrite the previous output of the print statement on the same line. Rather than creating a /n newline
