...
# logging.basicConfig(filename = "folderpath/filename", level = logging.DEBUG) # to see all error logs
...
# # logging.basicConfig(filename = "myFilelog.log", level = logging.ERROR)  # from error and above will be logged to file
# logging.basicConfig(filename=r"Python\Part8_Exceptions_SetsTuplesDictListsStartFiles\1_Exceptions\file.log",
...
logging.basicConfig(filename=r"Python\Part8_Exceptions_SetsTuplesDictListsStartFiles\1_Exceptions\myfilelog.log",
                    level=logging.DEBUG)  # to see all error logs
# different logging methods and severity
logging.critical("Critical")
logging.error("Error")
...
# Python\Part8_Exceptions_SetsTuplesDictListsStartFiles\1_Exceptions
