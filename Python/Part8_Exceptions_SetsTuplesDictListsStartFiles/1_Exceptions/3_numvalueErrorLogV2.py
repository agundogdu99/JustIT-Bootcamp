...
logging.basicConfig(filename=r"Python\Part8_Exceptions_SetsTuplesDictListsStartFiles\1_Exceptions\myfilelogwithTIME.log",
                    level=logging.DEBUG)
...
try:  # attempt to run the indented code block
    ...
    # logging.critical(f"On {time.asctime()}\nUser attempted to divide by zero")
