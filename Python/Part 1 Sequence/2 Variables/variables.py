...
"What is the function of the object's type when used in a print statement as shown below?"
print(type(num1))
print(type(num8))
print(type(name))

"This is what happens when you create a variable in python?"
# 1. Creates and int/float/string object (variable) by IMPLICIT CASTING automatically
...
name, address, interest = "Ahmet", "8 New Street", "Flying, exercise and programming"
print(name, address, interest)


"Chained assignment"
first_child = second_child = third_child = "Ahmet"
print(
...
# The differences
# Chained assignment will hold the same value throughout
# Changing a value of one of the variables will change the other,
#   as they are referring to the same point in memory
# Changing first_child will not change the others, changing second_child will change first_child
# NOT third_child, changing third_child will change the other two as well
...
# Python automatically creates variable TYPE through implicit casting
# If we want to define manually, we use Explicit casting
...
# In JS it can be used in Jquery naming, and in object literals
