...
print(type(None))  # None Type / Null

print(type("Hello"))  # str
print(type(f"My name is..."))
print(type("""Ahmet"""))
...
print(type(f"My name is..."))
print(type("""Ahmet"""))
print(type(bytes("A", "utf8")))  # A in bytes

# Produce two examples of numeric ?Boolean? datatypes
print(type(True))  # bool
print(type(False))
