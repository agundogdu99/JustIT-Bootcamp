...
SELECT *
FROM employee
WHERE salary = (SELECT MIN(salary) FROM employee WHERE salary IS NOT NULL)
ORDER BY salary ASC;

SELECT * FROM employee WHERE Fname="John" OR Fname="Alicia";
SELECT * FROM employee WHERE Fname IN("John", "Alicia");

-- Display all employees in the table?
SELECT * FROM employee;
-- Find the 5 employees who was born recently
SELECT * FROM employee ORDER BY BDATE DESC LIMIT 5;
-- Find all employees and sort them by sex then first name
SELECT * FROM employee ORDER BY sex, Fname;
-- Find 2 employees with highest salary
SELECT * FROM employee ORDER BY salary DESC LIMIT 2;
-- Find first name and last name of all  employees
SELECT Fname, Lname FROM employee;
-- find first name, last name and dob for 5 employees who are receiving lowest salary
SELECT Fname, Lname, Bdate FROM employee WHERE salary IS NOT NULL ORDER BY salary ASC LIMIT 5;
